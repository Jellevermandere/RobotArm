...
#robot.motorController.set_smooth_motors([0,90,180,90,0])
#robot.motorController.set_smooth_motors([0,90,0,0,0])
#time.sleep(1)
#robot.motorController.set_angles([0,90,90,0,0])
#time.sleep(2)
#robot.motorController.set_angles([0,90,180,0,0])
#time.sleep(2)
#robot.motorController.set_angles([0,90,180,0,0])
#time.sleep(2)
#robot.motorController.set_angles([0,120,120,0,0])
#time.sleep(2)
#while True:
#    time.sleep(1)
#robot.test_Motors()
